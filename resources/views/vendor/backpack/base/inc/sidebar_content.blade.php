...
<li class="nav-item nav-dropdown">
	<a class="nav-link nav-dropdown-toggle" href="#"><i class="nav-icon la la-users"></i> Manajemen Pengguna</a>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('link_terkait') }}'><i class='nav-icon la la-question'></i> Link_terkaits</a></li>